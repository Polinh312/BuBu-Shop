<%-- 
    Document   : inputupdateacc
    Created on : Oct 23, 2022, 4:02:41 PM
    Author     : Phuong-Linh
--%>
...
<html lang="zxx">
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="header__top__right">
                                ...
                                <div class="header__top__right__auth" style="margin-right:10px">
                                    <a href="profile"><i class="fa fa-user"></i>${sessionScope.account.fullname}</a>
                                </div>
                                <div class="header__top__right__auth" style="margin-right:10px">
    ...
    <div class="profile">
        ...
        <form action="deleteaccount">
            <div class="tt">
                <input class="inputX" type="text" name="loginname" placeholder="Nhập tên tài khoản"/><br><br>
