<%-- 
    ...
    Created on : Oct 22, 2022, 11:46:02 PM
    Author     : Phuong-Linh
--%>
    ...
    <body>
        ...
        <div class="profile">
            ...
            <form action="addproduct" method="POST">
                <div class="tt">
                    Mã sản phẩm: <br>
                    <input class="inputX" type="text" name="id"/><br><br>     
                    Tên sản phẩm: <br>
                    <input class="inputX" type="text" name="name"/><br><br>
                    Giá sản phẩm: <br>
                    <input class="inputX" type="text" name="price"/><br><br>
                    Mô tả sản phẩm: <br>
                    <textarea style="width: 400px; height: auto;"name="description"></textarea><br><br>
                    Giảm giá: <br>
                    <input class="inputX" type="text" name="discount"/><br><br>
                    Số lượng trong kho: <br>
                    <input class="inputX" type="text" name="stock"/><br><br> 
                    Danh mục: <br>
                    <c:set var="c" value="${requestScope.cate}"/>
                    <input class="inputX" type="text" name="category" value="${c.id}" readonly> <br><br>
                    Link ảnh: <br>
                    <input class="inputX" type="text" name="image"/><br><br>
                    Trọng lượng: <br>
                    <input class="inputX" type="text" name="weight"/><br><br>
                    Quốc gia: <br>
                    <select class="inputX" name="country">
                        <c:forEach items="${requestScope.listc}" var="c">
                            <option value="${c.id}">${c.name}</option>
                        </c:forEach>
                    </select> <br><br><br><br>
                    <button style="margin-left: 85px;" type="submit">Thêm vào danh sách sản phẩm</button><br><br>
                </div>
            </form>
