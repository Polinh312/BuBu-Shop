<%-- 
    ...
    Created on : Oct 23, 2022, 3:02:38 PM
    Author     : Phuong-Linh
--%>
                ...
                <div class="tt">
                    ...
                    <c:choose>
                        <c:when test = "${a.role == 'Admin'}">
                            <input class="inputX" type="radio" name="role" value="Admin" checked/> Admin
                            <input class="inputX" type="radio" name="role" value="Staff"/> Nhân viên
                            <input class="inputX" type="radio" name="role" value="Customer"/> Khách hàng <br><br>
                        </c:when>    
                        <c:when test = "${a.role == 'Staff'}">
                            <input class="inputX" type="radio" name="role" value="Admin"/> Admin
                            <input class="inputX" type="radio" name="role" value="Staff" checked/> Nhân viên
                            <input class="inputX" type="radio" name="role" value="Customer"/> Khách hàng <br><br>
                        </c:when> 
                        <c:otherwise>
                            <input class="inputX" type="radio" name="role" value="Admin"/> Admin
                            <input class="inputX" type="radio" name="role" value="Staff"/> Nhân viên
                            <input class="inputX" type="radio" name="role" value="Customer" checked/> Khách hàng <br><br>
                        </c:otherwise>
                    </c:choose>
                    <br><br>
                    <button style="margin-left: 45px" type="submit">Lưu thay đổi</button> <a style="margin-left: 20px" href="changepass">Đổi mật khẩu</a>
