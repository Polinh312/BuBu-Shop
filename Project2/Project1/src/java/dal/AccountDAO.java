...
public class AccountDAO extends DBContext {
    ...
    public Account check(String username, String password) {
        ...
        try {
            ...
            if (rs.next()) {
                return new Account(username, password, rs.getString("fullname"), rs.getString("email"), rs.getString("gender"), rs.getString("dob"), rs.getString("address"), rs.getString("phone"), rs.getString("role"));
            }
        } catch (Exception e) {
