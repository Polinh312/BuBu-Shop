<%-- 
    ...
    Created on : Nov 2, 2022, 12:11:13 PM
    Author     : Phuong-Linh
--%>
        ...
        <div class="profile">
            ...
            <form action="addcategory" method="POST">
                <div class="tt">
                    ...
                    <button style="margin-left: 85px;" type="submit">Thêm vào danh sách danh mục</button><br><br>
                </div>
            </form>
            <h3 style="margin-left: 120px">${requestScope.ms}</h3>
        </div>
        <!-- Js Plugins -->
