                ...
                <div class="tt">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            &nbsp; &nbsp; &nbsp; &nbsp; 
                            <input type="radio"  name="gender" value="0" checked/> Nữ <br>
                        </c:otherwise>
                    </c:choose>
                    <br><br>
                    Ngày sinh:<br>
                    ...
                    <c:choose>
                        <c:when test = "${a.role == 'Admin'}">
                            ...
                            &nbsp; &nbsp; &nbsp; &nbsp; 
                            <input  type="radio" name="role" value="Customer"/> Khách hàng <br>
                        </c:when>    
                        <c:when test = "${a.role == 'Staff'}">
                            <input  type="radio" name="role" value="Admin"/> Admin
                            &nbsp; &nbsp; &nbsp; &nbsp; 
                            <input  type="radio" name="role" value="Staff" checked/> Nhân viên
                            &nbsp; &nbsp; &nbsp; &nbsp; 
                            <input  type="radio" name="role" value="Customer"/> Khách hàng <br>
                        </c:when> 
                        <c:otherwise>
                            ...
                            <input  type="radio" name="role" value="Staff"/> Nhân viên
                            &nbsp; &nbsp; &nbsp; &nbsp; 
                            <input  type="radio" name="role" value="Customer" checked/> Khách hàng <br>
                        </c:otherwise>
                    </c:choose>
                    <br><br>
                    <button style="margin-left: 85px" type="submit">Lưu thay đổi</button> 
