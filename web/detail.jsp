<%-- 
    Document   : detail
    Created on : Oct 15, 2022, 11:41:02 PM
    Author     : Phuong-Linh
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            function addtocart(id) {
                document.f.action = "additem?id=" + id;
                document.f.submit();
            }
        </script>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="product__details__text">
                            ...
                            <form action="additem" method="GET">
                                ...
                                <button class="primary-btn" style="border: none"type="submit">Thêm vào giỏ hàng</button>   
                            </form>

                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                            <ul>

                                <li><b>Trọng lượng: </b> <span>${p.weight}</span></li>
                                <li><b>Quốc gia: </b> <span>${p.country}</span></li>
                                <li><b>Số lượng trong kho: </b> <span>${p.stock}</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab"
                                       aria-selected="false">Nhận xét của khách hàng<span>(1)</span></a>
                                </li>
                            </ul>
