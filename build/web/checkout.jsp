<%-- 
    Document   : checkout
    Created on : Oct 29, 2022, 11:16:50 AM
    Author     : Phuong-Linh
--%>
    ...
    <body>
        ...
        <div class="profile">
            ...
            <form action="addorder">
                ...
                <div class="tt">
                    Họ và tên:<br>
                    <input class="inputX" type="text" readonly name="fname" value="${a.fullname}"/> <br><br>
                    Email: <br>
                ...
                <button style="margin-left: 80px" type="submit">Đặt hàng</button> <a href="profile" style="margin-left:30px">Hoặc thay đổi thông tin tại đây</a>
            </form>
            <br><br>
        </div>     
        <!-- Js Plugins -->
